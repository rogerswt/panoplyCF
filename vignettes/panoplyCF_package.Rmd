...
## Looking at differential expression of clusters
...
NOTE: the data here are (a) subsampled, and (b) only 10 in each group, so this section isn't likely to find anything interesting but is included to illustrate the idea.  We encourage you to download \url{https://flowrepository.org/id/FR-FCM-ZZGS} in its entirety and follow this idea on the full data set.
